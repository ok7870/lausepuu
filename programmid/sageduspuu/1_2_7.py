        ...
        if filter <= oks["oksad"][sona[0]]["korrad"]:
            if "lisatuubid" in oks["oksad"][sona[0]]:
                for lisatuup in oks["oksad"][sona[0]]["lisatuubid"]:
                    ...
                    printsrting+=") "
            if protsent==True:
                print(" "*taane, sona[0], oks["oksad"][sona[0]]["korrad"], oks["oksad"][sona[0]]["korrad"]/lausearv, printsrting, file=programmvaljund)
            else:
...
if confolemas[0]:
    ...
    if kausat_faili_asukoht=="-":
        ...
        kausat_faili_asukoht=confolemas[1].readline().strip()
        if kausat_faili_asukoht=="?":
            kausat_faili_asukoht=input("teksti failide kausta/teksti faili asukoht: ")
...
#        kausat_faili_asukoht=confolemas[1].readline().strip()
#        if kausat_faili_asukoht=="?":
#            kausat_faili_asukoht=input("kausta asukoht: ")
#    else:
#        kausat_faili_asukoht=input("kausta asukoht: ")
#
#else:
