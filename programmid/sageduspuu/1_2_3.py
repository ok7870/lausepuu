...
def start_printer( oks, rekusioon=200000, filter=0, taane=0, seerekusioon=0):
    ...
    for sona in oks["oksad"]:
        if filter <= oks["oksad"][sona]["korrad"]:
            for lisatuup in oks["oksad"][sona]["lisatuubid"]:
                lisatuupmas=[]
                for siseminelisatuup in oks["oksad"][sona]["lisatuubid"][lisatuup]:
                    lisatuupmas.append([oks["oksad"][sona]["lisatuubid"][lisatuup][siseminelisatuup], siseminelisatuup])
                lisatuupmas.sort()
            ...
            print(" "*taane, sona, oks["oksad"][sona]["korrad"], printsrting, file=programmvaljund)
            printsrting=""
